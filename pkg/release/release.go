...
func (r *Release) Sync(client helm.Client, hr *v1.HelmRelease) (rHr *v1.HelmRelease, err error, sync bool) {
	...
	default:
		...
		return hr, ErrNoChartSource, sync
	}
	...
	if err != nil {
		...
		return hr, ErrComposingValues, sync
	}
